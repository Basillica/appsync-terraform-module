locals {
  ...
  # create lambda service policy statements
  ...
  # create dynamodb service policy statements
  ...
  # create elasticsearch policy statements
...
resource "aws_iam_role" "logs" {
  ...
  name                 = coalesce(var.logs_role_name, "${var.api_name}-logs")
